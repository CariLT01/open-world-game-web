...
export class Player {
    ...
    handleTranslation(delta: number) {
        ...
        this.playerBody.setLinvel({ x: newDir.x, y: this.playerBody.linvel().y, z: newDir.z }, true);
    }
    ...
    sendMovePacket() {
        ...
        ClientEventBus.fireEvent(EventBusEvent.SEND_PACKET, {packet: playerMovePacket});
    }
